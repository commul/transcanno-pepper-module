 ...
 */
@Component(name = "TranscannoImporterComponent", factory = "PepperImporterComponentFactory")
public class TranscannoImporter extends PepperImporterImpl implements PepperImporter{
	/** this is a logger, for recording messages during program process, like debug messages**/
	private static final Logger logger = LoggerFactory.getLogger(TranscannoImporter.class);
	 ...
	 * module unique.
	 */
	public TranscannoImporter() {
		super();
		setName("TranscannoImporter");
	 ...
	 * sample mapper of type {@link TranscannoMapper}, which only produces a fixed
	 * document-structure in method {@link TranscannoMapper#mapSDocument()} and
	 * enhances the corpora for further meta-annotations in the method
	 * {@link TranscannoMapper#mapSCorpus()}. <br/>
	 ...
	 * {@link TranscannoMapper#mapSDocument()} and enhances the corpora for further
	 * meta-annotations in the method {@link TranscannoMapper#mapSCorpus()}. <br/>
