 ...
 */
//@formatter:off
@Component(name = "TranscannoExporterComponent", factory = "PepperExporterComponentFactory")
//@formatter:on
public class TranscannoExporter extends PepperExporterImpl implements PepperExporter {
	// =================================================== mandatory
	// ===================================================
	/**
	 ...
	 * module unique.
	 */
	public TranscannoExporter() {
		super();
		setName("TranscannoExporter");
	 ...
	 * In this dummy implementation an instance of {@link TranscannoMapper} is
	 * created and its location to where the document-structure should be
	 * exported to is set.
	 */
	@Override
	public PepperMapper createPepperMapper(Identifier Identifier) {
		PepperMapper mapper = new TranscannoMapper();
