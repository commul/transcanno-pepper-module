...
import TranscannoSplitTagToOne.SplitToOne.TranscannoImporter;
 ...
 * {@link TranscannoImporter} class. Feel free to adapt and enhance this test class
 ...
 */
public class TranscannoImporterTest extends PepperImporterTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new TranscannoImporter());
	...
	public void test_DummyImplementation() {
		...
		getFixture().getCorpusDesc().setCorpusPath(getTempURI("TranscannoImporter"));
